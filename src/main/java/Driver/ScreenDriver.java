...
//       //runScreenLocalAlgorithmOtherDataSets("/Users/bhim/IdeaProjects/DBMS_MAJOR_PROJECT/src/main/resources/DatasetFuel-Final.txt");
//    }
    public static void main(String[] args) throws IOException
    {
        // PrintWriter object for file3.txt
        PrintWriter pw = new PrintWriter("/Users/bhim/IdeaProjects/DBMS_MAJOR_PROJECT/src/main/resources/stock1M.data");
        for(int i = 0 ; i < 100 ; i++ ) {
            // BufferedReader object for file1.txt
            BufferedReader br = new BufferedReader(new FileReader("/Users/bhim/IdeaProjects/DBMS_MAJOR_PROJECT/src/main/resources/stock10k.data"));
